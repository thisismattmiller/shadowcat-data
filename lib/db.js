...
exports.returnCollection = function(collectionName,cb){
	MongoClient.connect(mongoConnectURL, function(err, db) {
		var collection = (exports.testOverride) ? db.collection('test') : db.collection(collectionName)
...
exports.returnItemCount = function(id,cb,db){
	...
	if (db){
		...
		var collection = (exports.testOverride) ? db.collection('test') : db.collection('item')
		collection.count({bibIds : id}, function(err, count) {
			cb(err,count)
		});
...
exports.allBibs = function(cb){
	...
	MongoClient.connect(mongoConnectURL, function(err, db) {
		...
		var cursor = collection.find({_id: 12117171})
...
exports.insertAPIClassifyRecord = function(item,cb,db){
